...
import { createSubmissionSchema, mySubmissionsQuerySchema, problemSubmissionsParamsSchema, submissionIdParamsSchema } from "./submission.schema";

export const submissionRoutes = Router();

submissionRoutes.post("/", authMiddleware, validate(createSubmissionSchema), create);
submissionRoutes.get("/me", authMiddleware, validate(mySubmissionsQuerySchema), mine);
